...
| Doc | What it is |
|---|---|
| `Master_Curriculum_Pipeline.md` | **The PRD** — the full end-to-end mental model (authoring → artifacts → ingestion → app). Read this for "how does the whole thing work?" |
| `asset_registry.md` | Narrative inventory of every asset type and how it flows |
