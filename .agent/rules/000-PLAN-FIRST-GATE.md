...
The ONLY exception: the Antigravity system artifact directory itself (where `implementation_plan.md`, `task.md`, and `walkthrough.md` live) — surfaced through the IDE Artifacts panel, NOT a repository folder.
