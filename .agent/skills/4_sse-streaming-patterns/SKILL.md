...
- [multi-agent-orchestration.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/multi-agent-orchestration/SKILL.md) - 3-lane pattern that generates these events
- [regulatory-verification-protocol.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/regulatory-verification-protocol/SKILL.md) - When to send swap events
