...
- [multi-agent-orchestration.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/multi-agent-orchestration/SKILL.md) - How Experts A/B/C use these tools
- [regulatory-verification-protocol.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/regulatory-verification-protocol/SKILL.md) - How to verify citations
