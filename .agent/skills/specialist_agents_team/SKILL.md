...
- [dual-store-rag-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/dual-store-rag-patterns/SKILL.md) - How to query DB1 vs DB2
- [sse-streaming-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/sse-streaming-patterns/SKILL.md) - How to implement Swap events
- [regulatory-verification-protocol.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/regulatory-verification-protocol/SKILL.md) - What to verify
