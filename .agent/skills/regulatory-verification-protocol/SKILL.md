...
- [multi-agent-orchestration.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/multi-agent-orchestration/SKILL.md) - Lane 3 (Verifier) in the 3-lane pattern
- [dual-store-rag-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/dual-store-rag-patterns/SKILL.md) - How to query DB2 for evidence
- [sse-streaming-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/sse-streaming-patterns/SKILL.md) - How to send Swap events
