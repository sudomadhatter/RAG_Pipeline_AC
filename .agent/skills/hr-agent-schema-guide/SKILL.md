...
- [multi-agent-orchestration.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/multi-agent-orchestration/SKILL.md) - How agents coordinate
- [agent-handoff-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/agent-handoff-patterns/SKILL.md) - Context transfer protocols
