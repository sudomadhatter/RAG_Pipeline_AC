...
- [multi-agent-orchestration.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/multi-agent-orchestration/SKILL.md) - How agents coordinate in 3-lane pattern
- [firestore-schema-guide.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/firestore-schema-guide/SKILL.md) - What data to pass (profile schemas)
