...
See [dual-store-rag-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/dual-store-rag-patterns/SKILL.md) for complete implementation.
...
- [dual-store-rag-patterns.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/dual-store-rag-patterns/SKILL.md) - Complete dual-store implementation
- [multi-agent-orchestration.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/multi-agent-orchestration/SKILL.md) - How Investigation Swarm uses RAG
- [regulatory-verification-protocol.md](file:///C:/AGY-Projects/aviationChat-AGY/.agent/skills/regulatory-verification-protocol/SKILL.md) - Using DB2 for verification
